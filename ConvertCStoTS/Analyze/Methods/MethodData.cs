...
namespace ConvertCStoTS.Analyze.Methods
{
  ...
  public class MethodData
  {
    ...
    public MethodData(int indentSpaceCount, string methodName, string scope, List<ParameterData> paramList, string sourceCode, string returnValue, int baseArgCount = -1, string headerComment = "")
    {
